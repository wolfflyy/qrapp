<template>
  <div class="camera-container">
    <qrcode-stream :camera="camera" @decode="onDecode" @init="onInit">
      <div class="bounding-box" :style="{ width: boxSize, height: boxSize }"></div>
...
.bounding-box {
  ...
  border-radius: 25px;
  clip-path: polygon(0 0, 20% 0, 20% 20%, 0 20%, 0 80%, 20% 80%, 20% 100%, 0 100%, 80% 100%, 80% 80%, 100% 80%, 100% 20%, 80% 20%, 80% 0, 100% 0, 100% 100%, 0 100%);
  overflow: hidden;
}
